...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Antecedentes</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTable">
                    ...
                    <tbody>
                        <c:forEach items="${lstAntecedentes}" var="antecedente" >
                            <tr>
                                <td>
                                    <c:out value="${antecedente.familia.persona.nombre}" />
                                    <c:out value="${antecedente.familia.persona.app_paterno}" />
                                    <c:out value="${antecedente.familia.persona.app_materno}" />
                                </td>
                                <td><c:out value="${antecedente.familia.persona.rut}" /></td>
